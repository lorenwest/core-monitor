  ...
  */
  var Chart = core.Chart = Backbone.View.extend({
    ...
    initialize: function(options) {
      ...
      t.highcharts = t.viewOptions.get('highcharts') || {};
    ...
    render: function() {
      var t = this,
          highcharts = Monitor.deepCopy(t.highcharts, 10);
      highcharts.chart.renderTo = t.$el[0];
      t.chart = new Highcharts.Chart(highcharts);
  ...
  Chart.SettingsView = Backbone.View.extend({
    ...
    render: function() {
      ...
      t.series = t.$('.core-chart-data').val(JSON.stringify(t.hc.series[0].data));
