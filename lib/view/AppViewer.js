  ...
  */
  var AppViewer = core.AppViewer = Backbone.View.extend({
    ...
    initialize: function(options) {
      ...
      options.component.setDefaultSize({width: 600, height: 600});
    ...
    renderMemBar: function(title) {
      ...
      el.data('chart', new Highcharts.Chart(opts));
      return el;
    },
  ...
  AppViewer.SettingsView = Backbone.View.extend({
    ...
    render: function() {
      ...
      // Animate the charts?
      var elem =
        $('<span class="nm-core-av-anim-head">Smooth Animation:</span> <input type="checkbox" class="nm-core-av-anim"/>').appendTo(server);
